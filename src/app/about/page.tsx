...
export const metadata = buildMetadata({
  title: "من نحن",
  description:
    "قصّة سمارتك جروب — شركة سعودية متخصّصة في تطوير البرمجيات: المواقع، التطبيقات، أنظمة الأعمال، وحلول الذكاء الاصطناعي.",
  path: "/about",
});
...
const team = [
  ...
  { icon: Code2, role: "تطوير الواجهات", desc: "ويب وتطبيقات بأداء عالٍ وتجربة سلسة." },
  { icon: Database, role: "الأنظمة الخلفية", desc: "بنية خلفية آمنة وقابلة للتوسّع وتكامل API." },
  { icon: ShieldCheck, role: "ضمان الجودة", desc: "اختبار ومراجعة لضمان أداء موثوق ومستقر." },
  { icon: Sparkles, role: "ذكاء اصطناعي", desc: "دمج AI داخل الأنظمة لرفع الإنتاجية." },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            شركة سعودية متخصّصة في{" "}
            <span className="text-gradient">تطوير البرمجيات</span>
          </>
        }
        description="سمارتك جروب شركة سعودية متخصّصة في تطوير البرمجيات — نبني المواقع، التطبيقات، أنظمة الأعمال، وحلول الذكاء الاصطناعي للشركات في المملكة."
      />
        ...
        <div className="container-pad grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <div className="mt-5 space-y-4 text-[15px] leading-8 text-muted-foreground">
              ...
              <p>
                ومع تطوّر السوق السعودي، ركّزنا خبرتنا بالكامل على تطوير
                البرمجيات — من المواقع والتطبيقات إلى أنظمة الأعمال ولوحات
                التحكم وحلول الذكاء الاصطناعي.
              </p>
              <p>
                نحن اليوم{" "}
                ...
                — نبني الأنظمة الذكية والمنتجات البرمجية الموثوقة التي تُساعد
                الشركات السعودية على النمو رقمياً.
              </p>
            </div>
          </div>

export const site = {
  ...
  locale: "ar_SA",
  description:
    "سمارتك جروب — شركة سعودية تجمع بين الحلول البرمجية والإنتاج الإعلامي. نبني الأنظمة الذكية ونصنع المحتوى البصري لمساعدة المشاريع على النمو.",
  shortDescription:
    "نبني الأنظمة ونصنع المحتوى — حلول برمجية وإنتاج إعلامي من جدة.",
  keywords: [
    "شركة برمجة في جدة",
